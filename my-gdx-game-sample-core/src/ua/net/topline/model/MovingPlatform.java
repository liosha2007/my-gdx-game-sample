...
public class MovingPlatform {
	...
	public MovingPlatform(World world, float x, float y, float width,
			float height, float dx, float dy, float maxDist) {
	...
	private Body createBox(World world, BodyType type, float width,
